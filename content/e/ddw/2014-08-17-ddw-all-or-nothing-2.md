...
3 = { path = "kasandra-4.png", caption = "[Kasandra](@/w/kasandra.md) holds Audrey Bride in a Fireman's Carry. In the background, [Mira](@/w/mira.md) waits to tag in.", source = "WrestlingJunkies.wixsite.com" }
+++
