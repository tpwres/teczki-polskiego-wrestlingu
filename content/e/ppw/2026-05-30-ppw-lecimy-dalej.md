...
Lecimy Dalej (roughly _Let's Keep Going_) is an upcoming show by [PpW Ewenement's](@/o/ppw.md), returning to [Zaklęte Rewiry](@/v/zaklete-rewiry.md) in Wrocław.
...
* The Hardcors ([Johnny Blade](@/w/johnny-blade.md) & [Isnorr](@/w/isnorr.md)), who lost to [Rodzina](@/tt/rodzina.md) at [Ledwo Legalne 6](@/e/ppw/2026-05-16-ppw-ledwo-legalne-6.md), decided to have their revenge on the stable - represented by [Filip Fux](@/w/filip-fux.md) and [Isnorr](@/w/isnorr.md) - in a "Wrocław Braw". The match, announced on 24.05.2026, will include tables, ladders, chairs and other items, whereas the ring and the rules are "optional".
...
- - '[Olgierd](@/w/olgierd.md)'
  ...
  - c: '[PpW Championship](@/c/ppw-championship.md)'
    s: '#1 Contender'
    nc: upcoming
- - 'The Hardcors: [Johnny Blade](@/w/johnny-blade.md) & [Biesiad Strong](@/w/biesiad.md)'
