...
4 = { path = "matt2hot-vs-electrico.jpg", caption = "Matt2Hot (impostor) vs [Electrico](@/w/mister-z.md)", source = "Official PpW YouTube" }
+++
...
* [Electrico](@/w/mister-z.md) vs impostor Matt2Hot was kept as a surprise.
* The video never specifies which of the two wrestlers in the Main Event is the fake Matt2Hot and which is [Electrico](@/w/mister-z.md). One needs to be familiar with them from other events.
