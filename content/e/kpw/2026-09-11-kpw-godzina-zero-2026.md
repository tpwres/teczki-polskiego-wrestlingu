...
- - '[Zefir](@/w/zefir.md)'
  - 'Kornel'
  - g: Zefir promises to regain the Championship; asks a young fan to join him in the ring.
    x: [2] # Exclude Kornel from talent list
- - '[Krystian Malinowski](@/w/krystian-malinowski.md)'
  - '[Michał Fux](@/w/michal-fux.md)'
  - '[Oskar Haller](@/w/oskar-haller.md)'
  - '[Leon Lato](@/w/leon-lato.md)'
  - '[Zefir](@/w/zefir.md)'
  - g: Malinowski launches into an unhinged tirade, babyfaces put him in a straitjacket.
- credits:
...
* Despite being a team, Chemik and Oskar Haller did not get along. Chemik began the match by tagging in Oskar via a slap to the face (a favour Haller later returned) and ended it by throwing the tagged-out Haller out of the ring, before grabbing both Tag Team Championships for himself (summed up by Rosetti as _Chemik is the KPW Tag Team Champions_). Oskar then entered the ring and snatched one of the belts from Chemik's hand, much to the latter's chagrin.
...
* Battle Royal elimination order:
  ...
  3. Tomczak eliminates Leon Lato
  4. Tomczak eliminates Johan Otto
  5. Lukáš Mottl eliminates Adept Dwa
