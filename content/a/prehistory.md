...
authors = ["M3n747"]
[extra.gallery]
1 = { path = "supronstars.jpg", caption = "The only surviving photo of a SupronStars show ([Andrzej Supron](@/w/andrzej-supron.md) standing on the left, in black clothes).", source = "Wikipedia" }
+++
