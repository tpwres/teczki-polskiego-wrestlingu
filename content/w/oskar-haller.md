...
Oskar Haller is a wrestler working for [Kombat Pro Wrestling](@/o/kpw.md).

## Basic info

* Years active: 2025-
* Gimmicks/nicknames:
  - Adept Jeden {{ org_badge(orgs=['kpw']) }}
  - Oskar Fux {{ org_badge(orgs=['kpw']) }}
  - Oskar Haller {{ org_badge(orgs=['kpw', 'ppw', 'low', 'frpw']) }}
* Trained by:
...
Although he didn't have an official debut yet, Adept Jeden ("Rookie One") had a few fights at KPW shows. He made his first appearance at [Godzina Zero 2025](@/e/kpw/2025-08-22-kpw-godzina-zero-2025.md), where he faced [Tomczak](@/w/tomczak.md) in a 3-on-1 Handicap Match, alongside [Adept Dwa](@/w/adept-dwa.md) and [Adept Trzy](@/w/adept-trzy.md). The fan-given name "Adept Jeden" originated at this event, as the rookies weren't individually introduced.
