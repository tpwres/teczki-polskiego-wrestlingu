...
Note on rookies: throughout this website we use two notations, the Polish "adept" (men) or "adeptka" (women), and the English "_rookie_". "Adept/-ka" is treated as a part of the person's provisional ring name prior to earning the proper one. "_Rookie_", on the other hand, is used in conjunction with the wrestler's later ring name, when it is unknown how that worker was announced; this notation is used chiefly for older events, where sources are scarce. For example, Bartosz Plata is noted as "adept Bartek", but early appearances of David Oliwa are written as "_rookie_ David Oliwa".
