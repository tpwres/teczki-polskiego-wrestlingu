...
[extra.gallery]
1 = { path = "pas-zln-gng-kominiarz.jpg", caption = "[Unidentified Zielony](@/w/sedzia-seweryn.md) with first version of the ZLN GNG Championship belt.", source = "ZLN GNG Archives" }
2 = { path = "pas-zln-gng-rafael-kid.jpg", caption = "[Rafael Kid](@/w/rafael-kid.md) with second version of the ZLN GNG Championship belt.", source = "ZLN GNG Archives" }
+++
