...
Mystic Festival made use of B90 and the neighbouring [Drizzly Grizzly][drizzly], but also open-air spaces dubbed "Main Stage", "Park Stage" and "Desert Stage" (with B90 called "Shrine Stage", and Drizzly Grizzly "Sabbath Stage"). Behind Park Stage was an area called {{ map_pin(v="Mystic Festival's Chill Out Zone") }}"Chill Out Zone", used for PpW's showcase at the 2025 and 2026 festivals. [Centrum Stocznia Gdańska][csg] seems less popular nowadays, but in 2010s bands like KULT and Marillion played there, while Dyskusyjny Klub Filmowy "Miłość Blondynki" (_"Loves of a Blonde" Film Society_, attached to the [University of Gdańsk][ug]) held a _Film Massacre_ ("Masakra Filmowa") event there back in 2003.
...
[polsat]: https://en.wikipedia.org/wiki/Gda%C5%84sk_Stadium
