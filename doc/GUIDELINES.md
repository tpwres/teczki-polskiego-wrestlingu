...
- List references in the following order: Cagematch event page, official paid video, official free video, other links. See [PpW Miasto Bezprawia](https://tpwres.pl/e/ppw/2024-02-10-ppw-miasto-bezprawia/#references) for an example.
...
- Any notes/segment descriptions in the card should be written entirely in the present ("Wrestler X talks about his career path, shows respect to Wrestler Y").
